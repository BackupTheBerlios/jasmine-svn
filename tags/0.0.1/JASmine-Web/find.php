<?php
  /* Find.php: Provides a search page to find printer and users
       Version: Version: 0-27.05.2005 */
  ...
  function display_results($searchString, $objectType){  
	...
	foreach ($result as $line){
	  echo "    <li><a href=\"?section=show_$objectType&amp;$objectType=$line\">$line</a></li>\n";
	}
	echo "  </ul>\n";
	echo "</p>\n";
      }
